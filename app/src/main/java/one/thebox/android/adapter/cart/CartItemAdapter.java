...
public class CartItemAdapter extends BaseRecyclerAdapter {
    ...
    private OnBoxItemChange onBoxItemChange;
    /**
    ...
    public CartItemAdapter(Context context, RequestManager glideRequestManager, CartFragment cartFragment) {
        super(context);
    ...
    /**
     * Interface Called from CartAdapter
     *
     * @param onBoxItemChange
     */
    public void addOnBoxItemChangeListener(OnBoxItemChange onBoxItemChange) {
        this.onBoxItemChange = onBoxItemChange;
    }
    ...
    private class ItemViewHolder extends BaseRecyclerAdapter.ItemHolder {
        ...
        private void removeItemFromCart(BoxItem boxItem, int position) {
            ...
            if (onBoxItemChange != null) {
                onBoxItemChange.onBoxItem(boxItems);
            }
    ...
    /**
     * Interface to Communicate with CartAdapter
     */
    public interface OnBoxItemChange {
        void onBoxItem(List<BoxItem> boxItemList);
    }
